...
import 'package:resecure_camera/recording.dart';
...
class _RecordingsPageState extends State<RecordingsPage> {
  ...
  Future<void> _fetchRecordings() async {
    ...
    List<Recording> recordings =
        await firebaseDataService.fetchRecordings(cameraId, startDate, endDate);
    setState(() {
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  title: Text(DateFormat('yyyy-MM-dd HH:mm')
                      .format(recording.datetime)),
                  trailing: IconButton(
                    icon: const Icon(Icons.download),
                    onPressed: () => _downloadVideo(
                        recording.storagePath, recording.datetime.toString()),
                  ),
                );
              },
            ),
